<template>
  <svg
    class="app-icon"
    :class="[`icon-${name}`, { 'is-spinning': spin }]"
...
const icons = {
  ...
  bug: '<rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 6v2a4 4 0 0 1-8 0V6"></path><path d="M8 10H4a2 2 0 0 1 0-4h18a2 2 0 0 1 0 4h-4"></path><path d="M7 21V11"></path><path d="M17 21V11"></path><path d="M3 16h2"></path><path d="M19 16h2"></path>',
